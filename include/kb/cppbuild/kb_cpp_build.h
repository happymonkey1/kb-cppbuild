...
#ifndef KB_CPP_BUILD_H
#define KB_CPP_BUILD_H
...
auto create_executable(const executable_specification& p_specification) noexcept -> option<cppbuild_error_t> {
    ...
    const auto build_dir = s_cppbuild_specification.m_build_directory.has_value() &&
    ...
    KB_CORE_INFO("Running build command: '{}'", *cmd);
